...
- BrickPilot Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-based arcade game called BrickPilot Lite. It should be a Breakout-style paddle and brick game where the player moves a paddle, bounces a ball, clears brick rows, tracks score/lives/level progress, can pause/resume, restart after game over, and open a settings screen for difficulty, sp…
...
- Gameplay - BrickPilot Lite
- Game Settings - BrickPilot Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - BrickPilot Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - BrickPilot Lite
